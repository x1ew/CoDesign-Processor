...
for i in inputs:
    ...
    if opcode.lower() == 'load':
        outputs.append('00' + str(bin(int(arg1[1]))[2:].zfill(2)) + '11')
        outputs.append(str(bin(int(arg2))[2:].zfill(6)))
    elif opcode.lower() == 'add':
        outputs.append('01' + str(bin(int(arg1[1]))[2:].zfill(2)) + str(bin(int(arg2[1]))[2:].zfill(2)))
    elif opcode.lower() == 'sub':
        outputs.append('10' + str(bin(int(arg1[1]))[2:].zfill(2)) + str(bin(int(arg2[1]))[2:].zfill(2)))
    elif opcode.lower() == 'jnz':
        outputs.append('11' + str(bin(int(arg1[1]))[2:].zfill(2)) + '00')
        outputs.append(str(bin(int(dict[arg2]))[2:].zfill(6)))
    elif opcode.lower() == 'hlt':
        outputs.append('000000')
